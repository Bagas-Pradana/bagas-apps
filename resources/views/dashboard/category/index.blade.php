...
<section class="absolute top-0 w-[75%] right-0 z-10 pt-4">
    <div class="flex flex-col gap-y-6 w-[75%] ps-4 ">
        <h1 class="mx-auto font-bold text-2xl pl-4">List Category Postingan</h1>
        ...
        <a href="/dashboard/categories/create" class="self-start text-xl font-semibold px-3 pt-0.5 pb-1 bg-blue-600 inline-flex items-center gap-2 rounded-lg text-white">Create New Category List</a>
                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200">
                    ...
                    <td class="">
                        <div class="flex flex-wrap gap-1 justify-center">
                            <a href="/dashboard/blog/{{ $category->slug }}">
                            ...
                            <form action="/dashboard/blog/{{ $category->slug }}" method="post">
                                @method('delete')
                                @csrf
                            ...
                            <a href="/dashboard/blog/{{ $category->slug }}/edit">
